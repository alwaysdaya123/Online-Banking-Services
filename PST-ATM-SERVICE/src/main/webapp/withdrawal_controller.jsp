...
String wa = request.getParameter("withdrawal_amount");
double depositAmount = Double.parseDouble(wa);
...
try{
    ...
    if(i > 0) {
        out.println("<h1>Amount Withdrawal successfully please collect your cash...</h1>");
    } else {
        out.println("<h1>Amount withdrawal failed, please try again...</h1>");
    }
    con.close();
} catch(Exception e) {
    e.printStackTrace();
