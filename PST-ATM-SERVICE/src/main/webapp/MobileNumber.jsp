...
%>
<form action="MobileNumber_controller.jsp" method="post">
    <h2>ChangeMobileNumber</h2>
    <table>
        <tr>
        ...
        <tr>
            <td><label for="mobile_number">ChangeMobile Number:</label></td>
    ...
    <input type="submit" value="ChangeMobileNumber">
</form>
